    ...
    aside.innerHTML = `
        ...
        <h2>Exercises</h2>
            <ul>
                ...
                <li><a href="${rutaBase}ejercicios/ejercicio-4.html"><i class="fa-solid fa-bookmark"></i> Exercise 4: Creating a lobby room</a></li>
                <li><a href="${rutaBase}ejercicios/ejercicio-5.html"><i class="fa-solid fa-bookmark"></i> Exercise 5: Adding spawn points</a></li>
                <li><a href="${rutaBase}ejercicios/ejercicio-6.html"><i class="fa-solid fa-bookmark"></i> Exercise 6: Adding trigger collisions</a></li>
            </ul>
        </nav>
    `;
